...
namespace Baas\Generator;

use Illuminate\Filesystem\Filesystem;
use Baas\Generator\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    public function getAttributes()
    {
        ...
        if (config('baasgenerator.cache.enabled') === false) {
            return $attributes;
        }

        return app('cache')->remember($this->getPath(), config('baasgenerator.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }
